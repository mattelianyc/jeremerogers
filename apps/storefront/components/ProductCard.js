    ...
    <article>
      ...
      >
        <div className="relative aspect-[3/4] overflow-hidden bg-neutral-100">
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 hidden p-3 sm:p-4 lg:block">
        ...
        <div className="border-x border-b border-black/8 bg-[#e9dcc0]/72 px-4 py-3 text-black lg:hidden">
          <p className="text-[10px] uppercase tracking-[0.28em] text-black/52">
            {productCategory}
          </p>
          <h2 className="mt-2 text-base uppercase tracking-[0.14em] text-black">
            {product.title}
          </h2>
          <div className="mt-3 flex items-end justify-between gap-3">
            <p className="text-sm text-black">{productPrice}</p>
            <span className="relative inline-flex items-center pb-1 text-[10px] uppercase tracking-[0.28em] text-[#7f1d1d]">
              View product
              <span className="absolute inset-x-0 bottom-0 h-px bg-[#8b1e2d]/55" />
            </span>
          </div>
        </div>
      </motion.button>
